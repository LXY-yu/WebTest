...
<html>
  <head>
    ...
    <title>My JSP 'R_reHandle.jsp' starting page</title>
  ...
  <body>
    ...
    <form method="get" action="${pageContext.request.contextPath }/R_reHandleServlet" target="bfr" onSubmit="return validate()">
    <table border="1" width="40%" bordercolor="black">    
         
          <tr>
          <td>借书证号</td>  
          <td><input style="width:100%" type="text" name="oldrdID" value=${me.rdID} readonly="true"></td>
          </tr>
          <tr>
          <td>读者姓名</td>
          ...
          <tr>
          <td>管理角色</td>
          <td><input style="width:100%" type="text" name="rdAdminRoles" value=${me.rdAdminRoles} readonly="true">（0-读者、1-借书证管理、2-图书管理、4-借阅管理、8-系统管理）</td>
          </tr> 
          <tr>
          <td>请输入新借书证号：</td>
          <td><input style="width:100%" type="text" name="rdID"></td>
      </tr>                                   
      </table>
