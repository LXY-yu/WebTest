...
<html>
  <head>
    ...
    <title>My JSP 'R_DeleteCard.jsp' starting page</title>
 ...
 return true;
  ...
  <body>
    ...
    <form method="get" action="${pageContext.request.contextPath }/R_DeleteServlet" target="bfr" onSubmit="return validate()">
