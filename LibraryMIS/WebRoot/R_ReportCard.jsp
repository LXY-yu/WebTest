...
<html>
  <head>
    ...
    <title>My JSP 'R_ReportCard.jsp' starting page</title>
	...
	<script type="text/javascript">
     function validate(){
	  if(document.myform.rdStatus.value!="挂失" && document.myform.rdStatus.value!="有效"){
		  alert("输入不合规范，请重新输入！");
		  return false;
	  }
	  return true;
  ...
  <body>
    ...
    <table border="1" width="40%" bordercolor="black">    
          ...
          <tr>
          <td>证件状态</td>
          <td><input style="width:100%" type="text" name="rdStatus" value=${me.rdStatus}>（请输入有效、挂失）</td>
          </tr>
          <tr>
          <td>已借书数量</td>
