...
<body>
	...
	<center><div class="signin">
		...
		<form id="urlForm" class="form-signin" role="form" action="${pageContext.request.contextPath}/main" method="post">
			<input id="url" name="url" type="url" class="form-control" placeholder="网站入口" required autofocus /> <br />
