  ...
  <head>
	...
	<link href="should_be_excluded/css/style.css" rel="stylesheet"
		...
		<script>
					...
					if(icount.trim()!=0){
					  document.getElementById("a1").href="web/gglanmana/selectinputpro.jsp?page="+icount;
					  }else{
					   document.getElementById("a1").href="web/gglanmana/selectinputpro.jsp?page=1";
					  }
					}
			...
			<div class="dclass_container" id="div_rela_table">
				<div class="dclass_container_header">
					<div class="dclass_container_title">
						查询结果&nbsp;&nbsp;&nbsp;[<a href="web/gglanmana/proinput.jsp" >返回产品列表</a>]
					</div>
				</div>
				<div class="dclass_container_content">
					...
					<div class="dclass_pager ">
						<span class="dclass_pager_nav">  <a href="web/gglanmana/selectinputpro.jsp?page=1" >首页</a> </span>
						<%
							if ((view.getCurrentPage() - 1) <= 0) {
						 %>
						<span class="dclass_pager_nav"> <a href="web/gglanmana/selectinputpro.jsp?page=1">上一页</a>  </span>
						<%}else{ %>
						 <span class="dclass_pager_nav"><a href="web/gglanmana/selectinputpro.jsp?page=<%=(view.getCurrentPage() - 1)%>">上一页</a> </span>
						 <%} %>
						 <% 
						 if ((view.getCurrentPage() + 1) > view.getPageCount()) { 
						  %>
						<span class="dclass_pager_nav"> <a href="web/gglanmana/selectinputpro.jsp?page=<%=view.getPageCount() %>">下一页</a>  </span>
						<%}else{ %>
						<span class="dclass_pager_nav"> <a href="web/gglanmana/selectinputpro.jsp?page=<%=view.getCurrentPage()+1 %>">下一页</a>  </span>
						<%} %>
						<span class="dclass_pager_nav"> <a href="web/gglanmana/selectinputpro.jsp?page=<%=view.getPageCount() %>">末页</a>  </span>
