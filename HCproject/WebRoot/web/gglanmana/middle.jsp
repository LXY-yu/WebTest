...
<title>ego</title>
<style type="text/css">
.tag_box { width:430px; height:126px; border:1px solid #B0BEC7; font:12px Arial, Helvetica, sans-serif; margin:50px; overflow:hidden}
...
<table width="1000" height="300" border="1" >
  <tr style="width: 700px">
    ...
    <div class="tag_box" id="tag_menu" >
		...
		<li><a href="#" onClick="fivetag(this,1)" onFocus="this.blur()" class="curMenu">每日特价</a></li>
		</c:if>
		<c:if test="${no.count!=1}">
		<li><a href="#" onClick="fivetag(this,${no.count})" onFocus="this.blur()">${prode.type}</a></li>
		</c:if>
